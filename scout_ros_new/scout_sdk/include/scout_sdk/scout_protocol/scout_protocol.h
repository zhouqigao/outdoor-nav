...
#define UART_FRAME_MOTION_STATUS_ID         ((uint8_t)0x07)
#define UART_FRAME_MOTOR1_DRIVER_STATUS_ID  ((uint8_t)0x08)
#define UART_FRAME_MOTOR2_DRIVER_STATUS_ID  ((uint8_t)0x04)
#define UART_FRAME_MOTOR3_DRIVER_STATUS_ID  ((uint8_t)0x05)
#define UART_FRAME_MOTOR4_DRIVER_STATUS_ID  ((uint8_t)0x06)

#define UART_FRAME_SYSTEM_STATUS_ID         ((uint8_t)0x01)
#define UART_FRAME_LIGHT_MOTOR_STATUS_ID    ((uint8_t)0x02)
#define UART_FRAME_IMU_STATUS_ID            ((uint8_t)0x03)

#define UART_FRAME_LIGHT_STATUS_ID          ((uint8_t)0x09)
#define UART_FRAME_DEBUG_ID                 ((uint8_t)0xFF)


#define UART_FRAME_MOTION_CONTROL_ID        ((uint8_t)0x02)
#define UART_FRAME_LIGHT_CONTROL_ID         ((uint8_t)0x03)
...
} SystemStatusMessageAll;



// led and Motor Driver Feedback
typedef struct
{
    union {
        struct
        {
            uint8_t led_enable_head_mode_tail_mode;
...
typedef enum
{
    ...
    ScoutSystemStatusMsg = 0x01,
    ScoutLightMotorDriverStatusMsg = 0x02,
    ScoutImuStatusMsg = 0x03,

    ScoutLightStatusMsg = 0x07,
    ScoutMotorDriverStatusMsg = 0x08,
    ScoutMotionStatusMsg = 0x09
} ScoutStatusMsgType;
...
typedef struct 
{
    ...
    SystemStatusMessageAll system_status_msg_all;
    LightMotorDriverStatusMessage light_motor_status_msg;
    ImuStatusMessage imu_status_msg;
